# Doefin V2 — Modular Smart Contracts Using Diamond-3-Hardhat

This repository powers the smart contract architecture of **Doefin V2**, a decentralized platform for options trading based on Bitcoin mining difficulty. It is built using [EIP-2535 Diamond Standard](https://github.com/ethereum/EIPs/issues/2535) to support a highly modular, upgradeable, and gas-efficient smart contract system.

We are using the [diamond-3-hardhat](https://github.com/mudgen/diamond-3-hardhat) implementation by Nick Mudge as the foundation due to its production-readiness, modular structure, facet management tooling, and EIP-2535 compliance.
...
- **Manage shared state safely across facets**
