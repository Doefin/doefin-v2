...
describe("RouteSimulationFacet", function () {
    ...
    it("should simulate a BUY market order and return a match route", async () => {
        ...
        await mintAndApproveERC20({ to: maker, minter: owner, token: erc20, amount: amount.mul(2), spender: diamondAddress });
        ...
        const expectedOrderId = await exchangeFacet.callStatic.getNextOrderId() - 1;
