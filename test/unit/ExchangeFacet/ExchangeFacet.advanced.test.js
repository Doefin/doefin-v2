...
const { createLimitOrder, validateOrderState } = require("../../utils/orderUtils.js");
...
describe("Exchange Facet - Advanced Test Cases", function () {
    ...
    let diamondAddress, exchangeFacet, erc20, ercUnit, erc1155, conditionalFacet, conditionManagerFacet, adminConfig;
    ...
    describe("Gas Optimization Tests", function () {
        ...
        it("should efficiently insert order in middle of large book", async () => {
            ...
            const hasCorrectPrice = allOrders.some(price => price.eq(ethers.utils.parseEther("0.4")));
