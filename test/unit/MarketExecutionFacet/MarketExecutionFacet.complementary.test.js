...
describe("Market Execution Facet", function () {
    ...
    let mintAmount, unit, erc20Decimals = 6; // Mock token with 6 decimals
    ...
    it("should execute a BUY market order using Complementary match route", async () => {
        ...
        console.log("maker balance", (await erc20.balanceOf(maker.address)).toString())
        ...
        console.log("maker balance after transfer", (await erc1155.balanceOf(maker.address, yesId)).toString())
        ...
        console.log("total retrieved cost:", takerERC20Before.sub(takerERC20After).toString())
        console.log("totalCost", totalCost.toString())
